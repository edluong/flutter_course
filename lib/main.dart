...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) { //can add Widget before build() to make sure a Widget object is returned
    ...
    return MaterialApp( //root widget
      home: Scaffold( //background widget
        appBar: AppBar( //creates the blue bar widget
